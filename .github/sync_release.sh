...
UPSTREAM_REPO="https://github.com/MiSTer-devel/SlugCross_MiSTer.git"
CORE_NAME=(SlugCross)
...
UPSTREAM_CORE_NAME=(SlugCross)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(SlugCross.qpf)
COMPILATION_OUTPUT=(output_files/SlugCross.rbf)
